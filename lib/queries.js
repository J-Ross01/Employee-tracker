...
class Database {
    ...
    async updateEmployeeManager(employeeId, managerId) { // SQL query to update an employee's manager. 
        ...
        // No need to return the result since this function is only to execute an update operation. The display of the reult will appear when you update the employees role. 
    }
